...
public class MainActivity extends AppCompatActivity {
	...
	public void configureButtonNext(View v) {
		Button nextButton = (Button) findViewById(R.id.b_to_second);
    ...
    public static double eval(final String str) {
        return new Object() {
            ...
            double parseFactor() {
                ...
                if (eat('^')) x = Math.pow(x, parseFactor()); // экспонента
